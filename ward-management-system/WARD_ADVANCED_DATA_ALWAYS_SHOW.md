...
## Issue Fixed
Modified the Ward Advanced Data section to always show when there's an active Ward Basic Form, even if no data has been submitted yet. Ward admins can now see and fill out the form at any time.
...
- Ward admin can fill out the form at any time
...
1. **Always Available**: Ward admins can see and use the form as soon as it's created
...
4. **Flexible**: Ward admins can update data at any time
