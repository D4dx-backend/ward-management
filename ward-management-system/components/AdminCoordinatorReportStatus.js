            ...
            <thead>
              <tr className="border-b border-gray-200">
                ...
                {statusData.weeks.map(({ week, year }) => {
                  ...
                  const formNames = statusData.coordinatorStatus
                    .map(cd => cd.weeks[weekKey]?.formName)
                    .filter(name => name != null);
                  
                  // Get the first form name found (most cases will have the same form for all coordinators)
