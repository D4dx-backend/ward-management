...
export default function WardActivityLogs() {
  ...
  return (
    <Layout>
      <Head>
        <title>My Activity - Ward Management System</title>
      </Head>

      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">My Activity</h1>
          <p className="mt-1 text-sm text-gray-600">View your recent activity logs</p>
        </div>
        ...
        <Card>
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Filter Activity</h2>
