      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">View ward visits recorded by ward administrators</p>
          </div>
          <div className="flex space-x-3">
            <div className="bg-gray-100 text-gray-500 px-4 py-2 rounded-md cursor-not-allowed">
        ...
        <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm">
                <strong>Note:</strong> As a coordinator, you can view ward visits but cannot record new visits. 
                Ward visits should be recorded by the respective ward administrators.
              </p>
            </div>
          </div>
        </div>
